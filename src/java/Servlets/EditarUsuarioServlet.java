    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                out.println("  var inputEsp = document.getElementById('txtEspecialidad');");
                out.println("  if (tipo === 'especialista') {");
                out.println("    campoEsp.style.display = 'block';");
                out.println("    inputEsp.required = true;");
                out.println("  } else {");
                out.println("    campoEsp.style.display = 'none';");
                out.println("    inputEsp.required = false;");
                out.println("  }");
                out.println("}");
                ...
                out.println("<div class='form-group'><label style='display: inline-block; width: 100px; text-align: left; margin-right: 5px;'>Tipo de Usuario:</label>");
                ...
                out.println("<div class='form-group'><label style='display: inline-block; width: 100px; text-align: left; margin-right: 5px;'>Contraseña:</label>");
                out.println("<input type='password' name='contrasena' class='txt' placeholder='Nueva contraseña (dejar vacío para no cambiar)' autocomplete='new-password'></div>");
